...
> *Note*: The "instances from benchmark evaluation" are originally generated by running `BatchBMMIEvaluation.py`, which can be time-consuming.
> To save time, we provide the pre-generated results from our study for users who wish to skip this step. After downloading, please extract the archive to the `./Benchmarks/EvalResults/Instances` directory.
...
- **Benchmark Instances**: [Download Instances.egg](https://www.dropbox.com/scl/fi/3l5x5ty0b339sjyah5cg6/Instances.egg?rlkey=mkc4phig37zn9a05wp02uo5ed&dl=1)
